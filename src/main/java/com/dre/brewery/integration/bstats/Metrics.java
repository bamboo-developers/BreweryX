...
public final class Metrics {
    ...
    public Metrics(final JavaPlugin plugin, final int serviceId) {
        this.plugin = plugin;
        // Get the config file
        final var bStatsFolder = new File(plugin.getDataFolder().getParentFile(), "bStats");
        final var configFile = new File(bStatsFolder, "config.yml");
        ...
        // Load the data
        final var enabled = config.getBoolean("enabled", true);
        final var serverUUID = config.getString("serverUuid");
        final var logErrors = config.getBoolean("logFailedRequests", false);
        final var logSentData = config.getBoolean("logSentData", false);
        final var logResponseStatusText = config.getBoolean("logResponseStatusText", false);
        this.metricsBase =
                new MetricsBase(
                        "bukkit",
                        serverUUID,
    ...
    private void appendServiceData(final JsonObjectBuilder builder) {
        var versionString = this.plugin.getDescription().getVersion();
    ...
    public static final class MetricsBase {
        ...
        private static byte[] compress(final String str) throws IOException {
            ...
            try (final var gzip = new GZIPOutputStream(outputStream)) {
        ...
        private void startSubmitting() {
            ...
            // don't do it!
            final var initialDelay = (long) (1000 * 60 * (3 + Math.random() * 3));
            final var secondDelay = (long) (1000 * 60 * (Math.random() * 30));
        ...
        private void submitData() {
            final var baseJsonBuilder = new JsonObjectBuilder();
            this.appendPlatformDataConsumer.accept(baseJsonBuilder);
            final var serviceJsonBuilder = new JsonObjectBuilder();
            ...
            final var data = baseJsonBuilder.build();
        ...
        private void sendData(final JsonObjectBuilder.JsonObject data) throws Exception {
            ...
            final var url = String.format(REPORT_URL, this.platform);
            final var connection = (HttpsURLConnection) new URL(url).openConnection();
            // Compress the data to save bandwidth
            final var compressedData = compress(data.toString());
            ...
            try (final var outputStream = new DataOutputStream(connection.getOutputStream())) {
        ...
        private void checkRelocation() {
            ...
            if (System.getProperty("bstats.relocatecheck") == null
                ...
                // little "trick" ... :D
                final var defaultPackage =
                        new String(new byte[]{'o', 'r', 'g', '.', 'b', 's', 't', 'a', 't', 's'});
                final var examplePackage =
    ...
    public static final class SimplePie extends CustomChart {
        ...
        protected JsonObjectBuilder.JsonObject getChartData() throws Exception {
            final var value = this.callable.call();
    ...
    public static final class MultiLineChart extends CustomChart {
        ...
        @Override
        protected JsonObjectBuilder.JsonObject getChartData() throws Exception {
            final var valuesBuilder = new JsonObjectBuilder();
            final var map = this.callable.call();
    ...
    public static final class DrilldownPie extends CustomChart {
        ...
        public JsonObjectBuilder.JsonObject getChartData() throws Exception {
            ...
            for (final var entryValues : map.entrySet()) {
                final var valueBuilder = new JsonObjectBuilder();
                var allSkipped = true;
                for (final var valueEntry : map.get(entryValues.getKey()).entrySet()) {
    ...
    public abstract static class CustomChart {
        ...
        public final JsonObjectBuilder.JsonObject getRequestJsonObject(
            ...
            final var builder = new JsonObjectBuilder();
            builder.appendField("chartId", this.chartId);
            try {
                final var data = this.getChartData();
                if (data == null) {
    ...
    public static final class JsonObjectBuilder {
         ...
         * @return A reference to this object.
         */
        public final JsonObjectBuilder appendField(final String key, final String value) {
            if (value == null) {
         ...
         * @return A reference to this object.
         */
        public final JsonObjectBuilder appendField(final String key, final int value) {
         ...
         * @return A reference to this object.
         */
        public final JsonObjectBuilder appendField(final String key, final JsonObject object) {
            if (object == null) {
         ...
         * @return A reference to this object.
         */
        public final JsonObjectBuilder appendField(final String key, final int[] values) {
            if (values == null) {
                throw new IllegalArgumentException("JSON values must not be null");
            }
            final var escapedValues =
         ...
         * @return A reference to this object.
         */
        public final JsonObjectBuilder appendField(final String key, final JsonObject[] values) {
            if (values == null) {
                throw new IllegalArgumentException("JSON values must not be null");
            }
            final var escapedValues =
        ...
        public final JsonObject build() {
            ...
            final var object = new JsonObject(this.builder.append("}").toString());
            this.builder = null;
            return object;
        }
