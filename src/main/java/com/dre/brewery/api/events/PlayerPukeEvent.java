 ...
 */
public final class PlayerPukeEvent extends PlayerEvent implements Cancellable {
    ...
    public PlayerPukeEvent(final Player who, final int count) {
        super(who);
        this.count = count;
    }
    ...
    public BPlayer getBPlayer() {
        if (this.bPlayer == null) {
            this.bPlayer = BPlayer.get(this.player);
        }
        return this.bPlayer;
    }
