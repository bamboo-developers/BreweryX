...
public final class CauldronFile extends AbstractOkaeriConfigFile {
    ...
    public final Map<String, ConfigCauldronIngredient> getCauldronIngredients() {
        final Map<String, ConfigCauldronIngredient> map = new HashMap<>(this.cauldron);
        map.putAll(ConfigManager.getConfig(Config.class).getCauldron());
        return map;
    }

    // Better setter name
    public void setCauldronIngredients(final Map<String, ConfigCauldronIngredient> cauldron) {
