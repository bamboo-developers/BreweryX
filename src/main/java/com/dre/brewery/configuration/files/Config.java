...
@Getter
@Setter
public final class Config extends AbstractOkaeriConfigFile {
    ...
    @Override
    public final void onFirstCreation() {
    ...
    public final List<Material> getPukeItem() {
        return BUtil.getListSafely(this.pukeItem, Material.class);
    }

    public final float getStumblePercent() {
        return this.stumblePercent / 100f;
    }
