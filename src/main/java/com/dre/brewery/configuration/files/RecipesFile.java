...
@Setter
public final class RecipesFile extends AbstractOkaeriConfigFile {
    ...
    public final Map<String, ConfigRecipe> getRecipes() {
        final Map<String, ConfigRecipe> map = new HashMap<>(this.recipes);
